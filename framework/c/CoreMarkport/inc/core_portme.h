...
*/
  ...
  #define COMPILER_VERSION "ARMCC V5.06 update 4 (build 422)"
 #elif defined ( __ICCARM__ )
  #define COMPILER_VERSION "IAR C/C++ Compiler for ARM v7.80.4.12462"
 #endif
#endif
#ifndef COMPILER_FLAGS
 //#define COMPILER_FLAGS FLAGS_STR /* "Please put compiler flags here (e.g. -o3)" */
 #if defined ( __CC_ARM )
  #define COMPILER_FLAGS "-c --cpu Cortex-M4.fp -D__MICROLIB -g -O3 -Otime --apcs=interwork --split_sections -D__UVISION_VERSION=\"523\" -D_RTE_ -DSTM32L496xx -DUSE_HAL_DRIVER -DSTM32L496xx"
 #elif defined ( __ICCARM__ )
  #define COMPILER_FLAGS "--no_size_constraints --debug --endian=little --cpu=Cortex-M4 -e --dlib_config -Ohs --use_c++_inline"
 #endif
#endif
#ifndef MEM_LOCATION
